...
class ComunaRegionProvinciaSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $regions = [
            ...
            [4, 'Región de Atacama', 3],
            [5, 'Región de Coquimbo', 4],
            [6, 'Región de Valparaiso', 5],
            [7, 'Región Metropolitana de Santiago', 13],
            [8, 'Región del Libertador General Bernardo O\'Higgins', 6],
            [9, 'Región del Maule', 7],
            [10, 'Región de Ñuble', 16],
            [11, 'Región del Biobío', 8],
            [12, 'Región de La Araucanía', 9],
            [13, 'Región de Los Ríos', 14],
            [14, 'Región de Los Lagos', 10],
            [15, 'Región de Aysén del General Carlos Ibáñez del Campo', 11],
            [16, 'Región de Magallanes y de la Antártica Chilena', 12]
        ];
