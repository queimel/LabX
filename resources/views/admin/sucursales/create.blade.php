...
@section('title') Crear nueva sucursal @endsection
@section('content')
<form class="form p-t-20" method="POST" action="{{ route('admin.sucursales.store')}}" data-remote="true" id="create-form">
    @csrf
    ...
    <div class="form-group  @error('id_comuna') has-danger @enderror">
        <label for="">Region</label>
        <select class="custom-select @error('id_comuna') form-control-danger @enderror" id="region-sucursal" name="region_cliente" required>
            <option selected>Region</option>
            @foreach ($regiones as $region)
            <option value="{{$region->id}}">{{$region->nombre_region}}</option>
            @endforeach
    ...
    <div class="form-group @error('id_comuna') has-danger @enderror">
        <label for="">Provincia</label>
        <select class="custom-select @error('id_comuna') form-control-danger @enderror" id="provincia-sucursal" name="provincia_cliente" disabled
            required>
    ...
    <div class="form-group @error('id_comuna') has-danger @enderror">
        <label for="">Comuna</label>
        <select class="custom-select @error('id_comuna') form-control-danger @enderror" id="comuna-sucursal" name="id_comuna" disabled required>
        </select>
    </div>
...
@endsection
@section('footer')
    <button type="submit" class="btn btn-success waves-effect waves-light m-r-10" form="create-form">Crear Sucursal</button>
    <button class="btn btn-inverse waves-effect waves-light" id="closeBtn">Cancelar</button>
@endsection
