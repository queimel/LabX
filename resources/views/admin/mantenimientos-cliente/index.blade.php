        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-end">
                    <div>
                        <a class="btn btn-primary" href="{{ route('admin.mantenimientos-cliente.create', auth()->user()->profile->cliente->id)}}" data-remote="true"> 
                            <i class="fa fa-plus"></i> Crear Mantenimiento
                        </a>
                    </div>
                </div>
                    ...
                    <table id="usersTable" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-info btn-xs" href="{{ route('admin.mantenimientos-cliente.show', $mantenimiento)}}" data-toggle="tooltip" data-placement="top" title="Ver detalle mantenimiento" data-remote="true">
                                        <i class="fa fa-eye"></i>
                                    </a>
