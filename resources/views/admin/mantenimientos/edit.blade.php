...
@section('title') Editar mantenimiento @endsection
@section('content')
<form id="formEditarMantenimiento" action="{{ route('admin.mantenimientos.update', $mantenimiento)}}" method="POST" data-remote="true">
     @csrf
     @method('PUT')
     <div class="form-group">
        <label>Equipo</label>
...
@section('footer')
    <div class="form-group d-flex justify-content-end">
        <button type="submit" class="btn btn-success waves-effect waves-light m-r-10" form="formEditarMantenimiento">Editar equipo</button>
