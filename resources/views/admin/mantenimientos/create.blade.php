...
@section('title') Nuevo Mantenimiento @endsection
@section('content')
<form class="form" id="formCrearMantenimiento" action="{{ route('admin.mantenimientos.store')}}" method="POST" data-remote="true">
     @csrf
        <!-- select clientes casas matrices -->
        <div class="form-group @error('casa_matriz') has-danger @enderror">
            <label for="">Cliente</label>
...
@section('footer')
<div class="form-group d-flex justify-content-end">
    <button type="submit" class="btn btn-success waves-effect waves-light m-r-10" form="formCrearMantenimiento">Crear Mantenimiento</button>
